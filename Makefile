NAME          = interpret_flow
DEPEND        = flow interpret_arithmetic arithmetic parse_dot parse_cog parse_verilog parse_ucs parse_expression parse common
TEST_DEPEND   = flow interpret_arithmetic arithmetic parse_dot parse_cog parse_verilog parse_ucs parse_expression parse common
